        ...
        <Fragment a href="#about">
              ...
              <Grid container justify="center">
                <div style={styles.card}>
                  ...
                  <p style={styles.cardText}>
                    I collaborate with clients and peers to nurture and
                    transform ideas into well though out design specs. I also
                    help project managers identify specific criteria for
                ...
                <div style={styles.card}>
                  ...
                  <p style={styles.cardText}>
                    ...
                    structures, intuitive UI patterns and simple interactions.
                    I'm a minimalist who truly believes less is more.
                  </p>
                </div>
                ...
                <div style={styles.card}>
                  ...
                  <p style={styles.cardText}>
                    ...
                    and MySQL. I love coding things from scratch but can work
                    with a variety of librarires and frameworks.
                  </p>
                </div>
              </Grid>
            </Grid>
          ...
          <div id="banner" style={styles.banner}>
            <Typography style={styles.p2} component="p">
              ...
              <span> </span>
              <i
                class="fab fa-digital-ocean fa-2x"
                style={{ color: "#008bcf" }}
              />
              <span> </span>
